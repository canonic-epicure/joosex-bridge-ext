...
Class('JooseX.Bridge.Ext', {
    ...
    methods : {
        ...
        defaultConstructor : function () {
            ...
            return function (config) {
                if (!this.__TRAITS_PROCESSED__ && config && typeof config == 'object' && (config.traits || config.trait)) {
                    this.__TRAITS_PROCESSED__ = true
                    
                    this.detach()
                    
                    this.meta.extend({ does : (config.traits || config.trait) })
                }
                ...
                if (!this.__JOOSE_INIT_DONE__) {
                    ...
                    jooseConstructor.apply(this, arguments)
                }
    ...
    before : {
        ...
        prepareProps : function (extend) {
            if (extend.xtype) Ext.reg(extend.xtype, this.c)
            delete extend.xtype
        },
        ...
        processSuperClass: function () {
            ...
            if (!superClass.meta) {
                ...
                if (!superProto.initialize) Ext.apply(superProto, Joose.Proto.Object.prototype)
            }
        }
 ...
 */
Joose.Helper.my.register('ExtClass', JooseX.Bridge.Ext)